...
Parcel-well matches
```{r}
final_matches_joined = read.csv("Data/Well-parcel matches/final_matches_joined.csv")
...
wells%>%
  ggplot(aes(na_capacity, normalised_depth))+
  geom_boxplot()+
  theme_bw()
...
final_matches_grouped_by_subbasin%>%
  ...
  geom_point(colour = "#82628c")+
  theme_bw(14)+
  labs(x = "Percentile of Normalised Cropland Area Owned", y = "Mean Total Well Capacity Owned \n (Normalised)")
```
...
final_matches_grouped_by_subbasin%>%
  ...
  geom_point(colour = "skyblue4")+
  theme_bw(14)+
  labs(x = "Percentile of Normalised Cropland Area Owned", y = "Mean Total Well Depth Owned \n (Normalised)")
```
...
final_matches_grouped_by_subbasin%>%
  ...
  geom_point(colour = "skyblue4")+
  theme_bw(14)+
  labs(x = "Percentile of Normalised Cropland Value Owned", y = "Mean Total Well Depth Owned \n (Normalised)")
...
final_matches_grouped_by_subbasin%>%
  ...
  geom_point(colour = "#82628c")+
  theme_bw(14)+
  labs(x = "Percentile of Normalised Cropland Value Owned", y = "Mean Total Well Capacity Owned \n (Normalised)")
...
Other metrics, such as number of wells owned by percentile
```{r}
final_matches_grouped_overall%>%
  group_by(cropland_area_percentile)%>%
