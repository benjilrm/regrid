...
```{r, eval = F}
cropland_extent_raster_binary = rast("Data/Crop data/crops_3311.TIF")
```
...
```{r, eval = F}
gpkg_files = list.files("Regrid parcel data/Raw/", pattern = "\\.gpkg$", full.names = T)
...
st_write(wells_sf_filtered, "Data/Wells/Processed/filtered_wells_with_section.gpkg", delete_dsn = T)
```
```{r}
